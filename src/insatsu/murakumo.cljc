...
(defn collection
  [name]
  (str "com.etzhayyim.insatsu." name))
...
(def cell-specs {
  ...
  :shinka {:legacy-cell "shinka"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :printpartner {:legacy-cell "com-etzhayyim-apps-insatsu-printPartner"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "printpartner")]
     :required-gates common-gates
     :trigger "manifest cell printpartner"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :printmailjob {:legacy-cell "com-etzhayyim-apps-insatsu-printMailJob"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "printmailjob")]
     :required-gates common-gates
     :trigger "manifest cell printmailjob"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
